...
void APP_Spectrum(void) {
	...
	FreqCenter = gVfoState[gSettings.CurrentDial].RX.Frequency;
	bNarrow = gVfoState[gSettings.CurrentDial].bIsNarrow;
	CurrentModulation = gVfoState[gSettings.CurrentDial].gModulationType;
