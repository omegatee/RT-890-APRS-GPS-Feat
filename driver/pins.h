...
enum {
	...
	BOARD_GPIOA_USART2_TX   = GPIO_PINS_2,	///WT: GPS Receiver. PA2, MCU pin 12, USART2_TX
	BOARD_GPIOA_USART2_RX   = GPIO_PINS_3,	///WT: GPS Receiver. PA3, MCU pin 13, USART2_RX
	...
	BOARD_GPIOA_CHIP_SDA    = GPIO_PINS_12,	///WT: On-board unknown unpopulated socket. PA12(MUX5), MCU pin 33, I2C2_SDA
	...
	BOARD_GPIOB_USART1_TX   = GPIO_PINS_6, //  pin 42 of MCU (PB6)
	BOARD_GPIOB_USART1_RX   = GPIO_PINS_7, /// pin 43 of MCO (PB7)
	...
	BOARD_GPIOF_CHIP_SCL    = GPIO_PINS_6,	///WT: On-board unknown unpopulated socket. PF6(MUX0), MCU pin 35, I2C2_SCL
